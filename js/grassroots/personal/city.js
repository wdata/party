    ...
    function(data){
        if(data.code === 0){
            ...
            $.each(data.data,function(index,val){
                li += '<li><a href="cityCouncil.html?id='+ val.id +'"><img src="../../images/grassroots/personal/xiaoqi.png" alt ="#"/><div><section>'+ val.name +'</section><p>'+ val.userCount +'名成员</p></div></a></li>';
            });
            $(".city ul").append(li);
