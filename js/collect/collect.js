        ...
        function(data) {
            ...
            if(data.code === 0){
                $.each(data.data,function(i,val){
                    ...
                    html+="<li class='pic"+(i+1)+"'><a href='../templates/boao/show.html？id="+ val.id +"'><div class='title'>"+ val.title +"</div><img src='"+ unite_img_url + val.icon +"'/><i></i></a><div class='footer'><div class='like'><i class='icon'><img src='../images/collect/"+ shoucang +"' alt=''></i><span>"+ val.collects +"</span></div><div class='title'>"+ val.tagList[0].title +"</div></div></li>";
                });
                self.html(html);
                $(".footer>.like>.icon").tap(function(){
                    ...
                    ajax_qcy(
                        ...
                        "",
                        function(data) {
                            self.siblings("span").text(data.data.upvote);
                        }
                    );
                    return false;
                });
