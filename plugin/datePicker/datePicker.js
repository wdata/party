    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupYM(e) {
                _self.gearDate = document.createElement("div");
                _self.gearDate.className = "gearDate";
                _self.gearDate.innerHTML = '<div class=" date ">' +
                    '<section><a class = "cancel lcalendar_cancel" href="#">取消</a><a class = "determine lcalendar_finish" href="#">确定</a></section>'+               
                    '<div class="date_roll_mask">' +
                    '<div class="ym_roll">' +
                    '<div>' +
                    '<div class="gear date_yy" data-datetype="date_yy"></div>' +
            ...
            function setDateGearTooth() {
                ...
                if (date_yy && date_yy.getAttribute("val")) {
                    ...
                    for (var p = 0; p <= passY - 1; p++) {
                        itemStr += "<div class='tooth val"+(p)+"'>" + (_self.minY + p) + "</div>";
                    }
                    ...
                    if (!isNaN(top)) {
                        ...
                        $('.date_yy .tooth.val'+yyVal).css("color","#333333");
                    } else {
                        date_yy.style["-webkit-transform"] = 'translate3d(0,' + (8 - yyVal+1) + 'em,0)';
                        date_yy.setAttribute('top', 8 - yyVal+1 + 'em');
                    }
                } else {
                    return;
                }
                ...
                if (date_mm && date_mm.getAttribute("val")) {
                    ...
                    for (var p = 0; p < maxM - minM + 1; p++) {
                        itemStr += "<div class='tooth val"+(p+1)+"'>"+ (minM + p + 1) + "</div>";
                    }
                    date_mm.innerHTML = itemStr;
                    $(".date_mm .tooth.val"+(mmVal+1)).css("color","#333333");
                    if (mmVal > maxM) {
                        mmVal = maxM;
